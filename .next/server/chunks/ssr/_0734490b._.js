...
"[project]/utils/checkRule.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var RegraUsuario = /*#__PURE__*/ function(RegraUsuario) {
    ...
    RegraUsuario["suporteDoSistema"] = "suporteDoSistema";
...
function podeAcessarRota(regra, path) {
    if (checkRule(regra)) {
        // Usuários especiais podem acessar tudo
        return true;
    }
    if (isCliente(regra)) {
        // Clientes só podem acessar rotas que comecem com /cliente
        return path.startsWith("/catalogo");
    }
    // Outras regras não têm permissão
    return false;
}
}}),
...
// Utils
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$checkRule$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/checkRule.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        try {
            ...
            if (regra === __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$checkRule$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RegraUsuario"].cliente) {
...
//# sourceMappingURL=_0734490b._.js.map