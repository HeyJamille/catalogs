...
"[project]/app/signout/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function RegisterPage() {
    ...
    const [telefone, setTelefone] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("");
    const [cep, setCep] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("");
    const [confirmarSenha, setConfirmarSenha] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const handleRegister = async (e)=>{
        ...
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$fetchData$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setupApiClient"])(nome, email, senha);
    ...
    // red border
    const inputClass = (field)=>touched[field] && !eval(field) ? "w-full px-5 py-3 border border-red-400 rounded-xl shadow-sm focus:outline-none focus:ring-3 focus:ring-red-400 transition" : "w-full px-5 py-3 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-3 focus:ring-blue-400 transition";
...
//# sourceMappingURL=app_signout_page_tsx_9c074f41._.js.map