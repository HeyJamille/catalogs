...
export default function HeaderNav({
  ...
  return (
    <header className="flex items-center w-full max-w-full text-white shadow-none rounded-xl transition-all">
      <div className="flex w-full flex-col-reverse justify-between gap-6 md:flex-row md:items-center">
        <div className="capitalize">
          <nav className="w-max">
            <ol className="flex flex-wrap items-center w-full bg-opacity-60 rounded-md bg-transparent p-0 transition-all">
              <li className="flex items-center text-blue-gray-900 text-sm transition-colors duration-300 ">
                <Link href={`/dashboard`}>
                  <p className="block text-sm text-blue-900 opacity-50 transition-all hover:text-blue-500 hover:opacity-100">
                    Dashboard
                  </p>
                </Link>
